    ...
    <SelectPortal>
      ...
      >
        <SelectViewport as-child>
          <ScrollAreaRoot
            class="relative overflow-hidden max-h-[40vh]"
          ...
          >
            ...
            <ScrollAreaScrollbar
              class="flex select-none touch-none p-0.5 z-20 transition-colors duration-[160ms] ease-out absolute top-0 right-0 bottom-0 data-[orientation=vertical]:w-2"
